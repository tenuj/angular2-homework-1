...
export const RESORTS : Resort[] = [
  ...
  },
  {
    ...
    name : 'Litli Geysir',
    description : 'Отель Litli Geysir расположен на трассе 35 в долине Хёйкадалюр в Исландии, напротив знаменитого Большого Гейзера.',
    phone : '+354 480 6800',
    location : {
  ...
  },
  {
    ...
    description : ' Этот современный отель расположен неподалеку от достопримечательностей «Золотого Круга», в юго-западном городе Хелла.',
    phone : '+354 531 8010',
    location : {
  ...
  },
  {
    ...
    description : 'Этот гостевой дом с бесплатной гидромассажной ванной и бесплатной парковкой находится в деревне Селфосс в 350 метрах от геотермального плавательного бассейна.',
    phone : '+354 864 3250',
    location : {
